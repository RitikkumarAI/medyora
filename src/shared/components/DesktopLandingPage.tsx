...
import { 
  Search, MapPin, Calendar, ArrowRight, ShieldCheck, 
  Clock, Users, Star, Video, Home, FileText, Lock, 
  Bell, Headphones, Heart, CheckCircle2, ChevronDown, 
  Sparkles, X, Shield, Award, Check
} from "lucide-react";
    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-slate-950 text-slate-900 dark:text-slate-100 overflow-x-hidden font-sans transition-colors">
      ...
      <main id="main-content" tabIndex={-1} className="focus:outline-none">
          ...
          <div className="col-span-12 lg:col-span-6 space-y-7">
            ...
            >
              ...
              <div className="flex -space-x-2">
                <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=64&q=80" alt="Doctor" className="h-6 w-6 rounded-full border-2 border-white dark:border-slate-900 object-cover" />
                <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=64&q=80" alt="Doctor" className="h-6 w-6 rounded-full border-2 border-white dark:border-slate-900 object-cover" />
                <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=64&q=80" alt="Doctor" className="h-6 w-6 rounded-full border-2 border-white dark:border-slate-900 object-cover" />
                <img src="https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&w=64&q=80" alt="Doctor" className="h-6 w-6 rounded-full border-2 border-white dark:border-slate-900 object-cover" />
              </div>
              <span className="text-xs font-bold text-slate-500 dark:text-slate-400">{t("hero.badge_count")}</span>
            </motion.div>
            ...
            >
              ...
              {t("hero.headline_2_pre")} <span className="text-blue-600 dark:text-blue-400 font-serif italic">{t("hero.headline_2_you")}</span> {t("hero.headline_2_post")}
            </motion.h1>
            ...
            >
              <motion.div whileHover={badgeHover} className="flex items-center gap-3 p-3 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm cursor-pointer transition-all hover:shadow-md hover:border-blue-400 dark:hover:border-blue-500">
                ...
                <div className="min-w-0">
                  <h4 className="font-bold text-xs text-slate-900 dark:text-white leading-tight truncate">{t("hero.feat_instant_title")}</h4>
                  <p className="text-[10px] text-slate-500 dark:text-slate-400 truncate mt-0.5">{t("hero.feat_instant_desc")}</p>
                </div>
              </motion.div>
              ...
              <motion.div whileHover={badgeHover} className="flex items-center gap-3 p-3 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm cursor-pointer transition-all hover:shadow-md hover:border-blue-400 dark:hover:border-blue-500">
                ...
                <div className="min-w-0">
                  <h4 className="font-bold text-xs text-slate-900 dark:text-white leading-tight truncate">{t("hero.feat_verified_title")}</h4>
                  <p className="text-[10px] text-slate-500 dark:text-slate-400 truncate mt-0.5">{t("hero.feat_verified_desc")}</p>
                </div>
              </motion.div>
              ...
              <motion.div whileHover={badgeHover} className="flex items-center gap-3 p-3 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm cursor-pointer transition-all hover:shadow-md hover:border-blue-400 dark:hover:border-blue-500">
                ...
                <div className="min-w-0">
                  <h4 className="font-bold text-xs text-slate-900 dark:text-white leading-tight truncate">{t("hero.feat_queue_title")}</h4>
                  <p className="text-[10px] text-slate-500 dark:text-slate-400 truncate mt-0.5">{t("hero.feat_queue_desc")}</p>
                </div>
              </motion.div>
              ...
              <motion.div whileHover={badgeHover} className="flex items-center gap-3 p-3 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm cursor-pointer transition-all hover:shadow-md hover:border-blue-400 dark:hover:border-blue-500">
                ...
                <div className="min-w-0">
                  <h4 className="font-bold text-xs text-slate-900 dark:text-white leading-tight truncate">{t("hero.feat_payments_title")}</h4>
                  <p className="text-[10px] text-slate-500 dark:text-slate-400 truncate mt-0.5">{t("hero.feat_payments_desc")}</p>
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px] font-bold text-slate-600 dark:text-slate-300">{t("search.available_today")}</span>
                </div>
                <p className="text-sm font-black text-slate-900 dark:text-white">{t("search.doctors_count")}</p>
              </motion.div>
              ...
              >
                <p className="text-[11px] font-bold text-slate-500 dark:text-slate-400">{t("search.avg_rating")}</p>
                ...
                <p className="text-[11px] text-slate-400 font-medium">{t("search.reviews_count")}</p>
              </motion.div>
              ...
              >
                <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-md rounded-full p-1.5 pl-2 shadow-xl border border-slate-100 dark:border-slate-800 flex items-center gap-1.5">
                  <div className="flex -space-x-2">
                    <img src="https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&w=64&q=80" alt="Doctor" className="h-8 w-8 rounded-full border border-white dark:border-slate-800 object-cover" />
                    <img src="https://images.unsplash.com/photo-1594824476967-48c8b964273f?auto=format&fit=crop&w=64&q=80" alt="Doctor" className="h-8 w-8 rounded-full border border-white dark:border-slate-800 object-cover" />
                    <img src="https://images.unsplash.com/photo-1537368910025-700350fe46c7?auto=format&fit=crop&w=64&q=80" alt="Doctor" className="h-8 w-8 rounded-full border border-white dark:border-slate-800 object-cover" />
                  </div>
        ...
        <motion.div 
          ...
          className="mt-12"
        >
          <form onSubmit={handleSearchSubmit} className="bg-white dark:bg-slate-900 p-3.5 sm:p-5 rounded-[32px] border border-slate-200 dark:border-slate-800 shadow-[0_15px_50px_rgba(0,0,0,0.06)] dark:shadow-2xl flex flex-col md:flex-row items-center gap-4 relative z-30 transition-all hover:border-blue-300 dark:hover:border-blue-600">
            ...
            <div className="flex items-center gap-3.5 px-4 py-2 flex-1 w-full relative">
              ...
              {searchQuery && (
                <button type="button" onClick={() => setSearchQuery("")} className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 p-1">
                  <X className="h-4 w-4" />
                </button>
              )}
            </div>
            ...
            <div className="relative flex-1 w-full">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm font-bold text-slate-900 dark:text-white truncate mt-0.5">{selectedDate}</p>
                </div>
                    ...
                    {DATE_OPTIONS.map((opt) => (
                      <button
                        ...
                        className={`w-full text-left px-3.5 py-2.5 rounded-xl text-xs font-semibold transition-colors ${
                          selectedDate === opt ? "bg-blue-600 text-white font-bold" : "text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800"
                        }`}
                      >
                        {opt}
                      </button>
            ...
            <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="w-full md:w-auto">
              <Button type="submit" className="w-full md:w-auto h-14 px-10 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm shadow-lg shadow-blue-600/30 flex items-center justify-center gap-2 shrink-0">
      ...
      <section className="px-6 sm:px-10 lg:px-16 w-full max-w-[1536px] mx-auto mb-16">
        ...
        >
          ...
          <motion.div whileHover={{ scale: 1.03 }} className="flex items-center gap-3.5">
            ...
            <div>
              <h4 className="font-bold text-xs text-slate-900 dark:text-white leading-tight">{t("trust_bar.secure_title")}</h4>
              <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">{t("trust_bar.secure_desc")}</p>
            </div>
          </motion.div>
          ...
          <motion.div whileHover={{ scale: 1.03 }} className="flex items-center gap-3.5">
            ...
            <div>
              <h4 className="font-bold text-xs text-slate-900 dark:text-white leading-tight">{t("trust_bar.google_title")}</h4>
              <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">{t("trust_bar.google_desc")}</p>
            </div>
          </motion.div>
          ...
          <motion.div whileHover={{ scale: 1.03 }} className="flex items-center gap-3.5">
            ...
            <div>
              <h4 className="font-bold text-xs text-slate-900 dark:text-white leading-tight">{t("trust_bar.appointments_title")}</h4>
              <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">{t("trust_bar.appointments_desc")}</p>
            </div>
          </motion.div>
          ...
          <motion.div whileHover={{ scale: 1.03 }} className="flex items-center gap-3.5">
            ...
            <div>
              <h4 className="font-bold text-xs text-slate-900 dark:text-white leading-tight">{t("trust_bar.partnered_title")}</h4>
              <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">{t("trust_bar.partnered_desc")}</p>
            </div>
          </motion.div>
          ...
          <motion.div whileHover={{ scale: 1.03 }} className="flex items-center gap-3.5">
            ...
            <div>
              <h4 className="font-bold text-xs text-slate-900 dark:text-white leading-tight">{t("trust_bar.support_title")}</h4>
              <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">{t("trust_bar.support_desc")}</p>
            </div>
          </motion.div>
        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-950 dark:text-white">
              Find Doctors by <span className="text-blue-600 dark:text-blue-400">Speciality & Organ</span>
            </h2>
            <p className="text-sm text-slate-500 dark:text-slate-400 font-medium mt-1">
              Easily recognize doctors by visual organ illustrations, symptoms, and Hindi guides.
            </p>
          </div>
          <Button asChild variant="outline" className="rounded-2xl text-xs font-bold border-slate-200 dark:border-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800">
            <Link to="/specialities">
              See All Specialities ({SPECIALIZATIONS.length})
            </Link>
          </Button>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3">
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-950 dark:text-white">
                {t("recommended.title")} <span className="text-blue-600 dark:text-blue-400">in {selectedCity}</span>
              </h2>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 font-medium mt-1">
              Verified top specialists in {selectedCity} available for in-clinic or video appointments
            </p>
          </div>
          <Button asChild variant="outline" className="rounded-2xl text-xs font-bold border-slate-200 dark:border-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800">
            <Link to="/doctors" search={{ city: selectedCity }}>
              {t("recommended.view_all")} ({DOCTORS.filter(d => d.city.toLowerCase() === selectedCity.toLowerCase()).length || DOCTORS.length})
            </Link>
          </Button>
        </div>
              ...
              >
                <div>
                  <div className="relative h-48 w-full rounded-2xl overflow-hidden mb-4 bg-slate-100 dark:bg-slate-800">
                    <img src={doc.image} alt={doc.fullName} className="h-full w-full object-cover object-top group-hover:scale-105 transition-transform duration-500" />
                  ...
                  <h3 className="font-bold text-base text-slate-900 dark:text-white leading-tight">{doc.fullName}</h3>
                  <p className="text-xs font-bold text-blue-600 dark:text-blue-400 mt-1">{doc.speciality}</p>
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 truncate">{doc.clinic.name}, {doc.clinic.area ? `${doc.clinic.area}, ${doc.clinic.city}` : doc.clinic.city}</p>
                  ...
                  <div className="flex items-center justify-between pt-3 mt-3 border-t border-slate-100 dark:border-slate-800 text-xs">
                    <span className="font-bold text-slate-900 dark:text-white flex items-center gap-1">
                      <Star className="h-3.5 w-3.5 fill-amber-400 text-amber-400" /> {doc.rating} ({doc.totalReviews})
                    </span>
                    <span className="font-black text-base text-slate-900 dark:text-white">₹{doc.fee}</span>
                  </div>
                </div>

                <Button asChild className="w-full mt-4 h-12 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs shadow-md shadow-blue-600/20">
      ...
      <section className="py-12 px-6 sm:px-10 lg:px-16 w-full max-w-[1536px] mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-950 dark:text-white">{t("articles.title")}</h2>
            <p className="text-sm text-slate-500 dark:text-slate-400 font-medium mt-1">{t("articles.subtitle")}</p>
          </div>
          <Button asChild variant="outline" className="rounded-2xl text-xs font-bold border-slate-200 dark:border-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {HEALTH_ARTICLES_DATA.slice(0, 3).map((art) => (
            <motion.div key={art.id} whileHover={{ y: -5 }}>
              ...
              >
                <div>
                  <img src={art.image} alt={art.title} className="h-48 w-full rounded-2xl object-cover mb-3.5 group-hover:scale-[1.02] transition-transform" />
                ...
                <div className="flex items-center justify-between pt-3.5 mt-3.5 border-t border-slate-100 dark:border-slate-800 text-xs text-slate-400">
                  <span className="font-semibold text-slate-600 dark:text-slate-300">{art.author.name}</span>
                  <span>{art.readTime} {t("articles.read_time")}</span>
                </div>
              </Link>
            </motion.div>
          ))}
