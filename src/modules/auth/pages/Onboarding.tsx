  ...
  return (
    <div className="flex flex-col h-[100dvh] w-full bg-[#F8FAFC] overflow-hidden select-none">
      ...
      <div className="px-6 pb-6 pt-3 shrink-0 relative z-10 bg-gradient-to-t from-[#F8FAFC] via-[#F8FAFC] to-transparent w-full max-w-md mx-auto space-y-3">
        ...
        <Button
          asChild
          className="w-full h-13 sm:h-14 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white text-[15px] font-bold shadow-lg shadow-blue-600/25 flex justify-between px-6"
        >
        ...
        <Button
          asChild
          variant="outline"
          className="w-full h-13 sm:h-14 rounded-2xl border-2 border-blue-600 text-blue-600 hover:bg-blue-50 text-[15px] font-bold flex justify-between px-6 bg-transparent"
        >
          <Link to="/auth/login">
        ...
        <div className="text-center pt-1 pb-1 space-y-0.5">
          <p className="text-xs font-semibold text-slate-500">Your Health. Our Priority.</p>
