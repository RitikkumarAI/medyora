      ...
      <main className="flex-1 px-6 flex flex-col">
        <div className="mb-8">
          ...
          <p className="text-sm text-slate-500">
            Select the language you prefer for a better experience
          </p>
        </div>
        ...
        <div className="space-y-4">
          {SUPPORTED_LANGUAGES.map((lang) => (
            ...
            >
              <div
                className={`w-10 h-10 rounded-full flex items-center justify-center font-medium text-lg mr-4 ${
              ...
              <div className="flex-1 text-left">
                <p
                  className={`font-bold text-base ${selected === lang.code ? "text-blue-900" : "text-slate-900"}`}
                >
                  {lang.label}
                </p>
