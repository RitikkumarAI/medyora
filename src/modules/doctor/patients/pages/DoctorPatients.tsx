...
const PATIENTS = [
  ...
  },
  {
    ...
    type: "New",
    image: "https://ui-avatars.com/api/?name=Anjali+Singh&background=fdf4ff&color=c026d3",
  },
  {
    id: "p3",
    name: "Rahul Sharma",
  ...
  },
  {
    ...
    lastVisit: "Today",
    type: "New",
    image: "https://ui-avatars.com/api/?name=Neha+Patel&background=f0fdf4&color=15803d",
  },
];
    ...
    <div className="flex flex-col min-h-screen bg-[#F8FAFC]">
      ...
      <header className="sticky top-0 z-40 bg-white px-4 pt-6 pb-4 shadow-sm border-b border-slate-100">
        ...
        <div className="flex gap-2">
          ...
          <Button
            variant="outline"
            className="h-12 w-12 shrink-0 rounded-2xl bg-white border-slate-200 shadow-sm text-slate-700"
          >
      ...
      <main className="flex-1 overflow-y-auto px-4 py-6 space-y-4 pb-24">
        {filtered.map((p) => (
          <div
            key={p.id}
            className="bg-white p-4 rounded-3xl border border-slate-100 shadow-sm flex flex-col gap-4"
          >
            <div className="flex items-start justify-between">
              ...
              <div
                className={`text-[10px] font-bold px-2 py-1 rounded-lg ${p.type === "New" ? "bg-green-100 text-green-700" : "bg-blue-100 text-blue-700"}`}
              >
                {p.type}
              </div>
            </div>
