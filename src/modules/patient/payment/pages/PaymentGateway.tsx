  ...
  if (status === "success") {
    return (
      <div className="min-h-screen bg-green-500 flex flex-col items-center justify-center p-6 text-center animate-in fade-in zoom-in-95 duration-500">
        ...
        <Link
          to="/patient"
          className="w-full max-w-sm h-14 rounded-2xl bg-white text-green-600 font-bold flex items-center justify-center shadow-lg"
        >
          Back to Home
        </Link>
      </div>
    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col items-center justify-center p-6 text-center animate-in fade-in zoom-in-95 duration-500 font-sans">
        ...
        <Button
          ...
          className="w-full max-w-sm h-14 rounded-2xl bg-blue-600 text-white font-bold text-sm shadow-lg shadow-blue-600/30"
        >
          Retry Payment
        </Button>
      </div>
    ...
    <div className="flex flex-col min-h-screen bg-[#F8FAFC] dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans transition-colors">
      ...
      <main className="flex-1 overflow-y-auto px-4 py-6 space-y-6 pb-32">
        ...
        <section>
          ...
          {!couponApplied ? (
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="h-12 rounded-2xl bg-slate-900 dark:bg-blue-600 text-white font-bold px-6"
              >
                Apply
              </Button>
            </div>
          ...
          {!couponApplied && (
            <p className="text-[10px] font-medium text-slate-500 dark:text-slate-400 mt-2 px-2">
              Try code: SAVE20
            </p>
          )}
        </section>
        ...
        <section>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-xs overflow-hidden">
            {/* UPI Option */}
            <div
              className={`border-b border-slate-100 dark:border-slate-800 transition-colors ${method === "upi" ? "bg-blue-50/50 dark:bg-blue-950/40" : "hover:bg-slate-50 dark:hover:bg-slate-800"}`}
            >
              <button
              ...
              >
                <div
                  className={`h-10 w-10 rounded-xl flex items-center justify-center shrink-0 ${method === "upi" ? "bg-blue-600 text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-500"}`}
                >
                ...
                <div
                  className={`h-5 w-5 rounded-full border-2 flex items-center justify-center ${method === "upi" ? "border-blue-600" : "border-slate-300 dark:border-slate-700"}`}
                >
              ...
              {method === "upi" && (
                <div className="px-4 pb-4 pt-2 ml-14">
                  <Input
                    ...
                    className="h-12 rounded-xl bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white"
                  />
                </div>
              )}
            </div>
            ...
            {/* Card Option */}
            <div
              className={`border-b border-slate-100 dark:border-slate-800 transition-colors ${method === "card" ? "bg-blue-50/50 dark:bg-blue-950/40" : "hover:bg-slate-50 dark:hover:bg-slate-800"}`}
            >
              <button
              ...
              >
                <div
                  className={`h-10 w-10 rounded-xl flex items-center justify-center shrink-0 ${method === "card" ? "bg-blue-600 text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-500"}`}
                >
                ...
                <div
                  className={`h-5 w-5 rounded-full border-2 flex items-center justify-center ${method === "card" ? "border-blue-600" : "border-slate-300 dark:border-slate-700"}`}
                >
              ...
              {method === "card" && (
                <div className="px-4 pb-4 pt-2 ml-14 space-y-3">
                  ...
                  <div className="flex gap-3">
                    <Input
                      placeholder="MM/YY"
                      className="h-12 rounded-xl bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white flex-1"
                    />
                    <Input
                      placeholder="CVV"
                      type="password"
            ...
            {/* Net Banking Option */}
            <div
              className={`border-b border-slate-100 dark:border-slate-800 transition-colors ${method === "netbanking" ? "bg-blue-50/50 dark:bg-blue-950/40" : "hover:bg-slate-50 dark:hover:bg-slate-800"}`}
            >
              <button
              ...
              >
                <div
                  className={`h-10 w-10 rounded-xl flex items-center justify-center shrink-0 ${method === "netbanking" ? "bg-blue-600 text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-500"}`}
                >
                ...
                <div
                  className={`h-5 w-5 rounded-full border-2 flex items-center justify-center ${method === "netbanking" ? "border-blue-600" : "border-slate-300 dark:border-slate-700"}`}
                >
                  {method === "netbanking" && (
            ...
            {/* Wallet Option */}
            <div
              className={`transition-colors ${method === "wallet" ? "bg-blue-50/50 dark:bg-blue-950/40" : "hover:bg-slate-50 dark:hover:bg-slate-800"}`}
            >
              <button
              ...
              >
                <div
                  className={`h-10 w-10 rounded-xl flex items-center justify-center shrink-0 ${method === "wallet" ? "bg-blue-600 text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-500"}`}
                >
                ...
                <div
                  className={`h-5 w-5 rounded-full border-2 flex items-center justify-center ${method === "wallet" ? "border-blue-600" : "border-slate-300 dark:border-slate-700"}`}
                >
