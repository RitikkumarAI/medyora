...
export function Payment() {
  ...
  // In a real app we'd validate these, but we fallback gracefully
    ...
    <div className="flex flex-col min-h-screen bg-[#F8FAFC] pb-24">
      ...
      <main className="flex-1 px-6 py-4 space-y-6">
        ...
        <div className="bg-white rounded-3xl p-5 shadow-sm border border-slate-100">
          <h2 className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-4">Appointment Summary</h2>
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <img src={doctor.image} alt={doctor.fullName} className="h-12 w-12 rounded-full object-cover" />
              <div>
          ...
          <div className="bg-[#F8FAFC] rounded-2xl p-4 flex justify-between items-center">
            <div>
              ...
              <p className="text-sm font-bold text-slate-900">{search.date || "2025-05-14"} • {search.time || "10:00 AM"}</p>
            </div>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div className="flex-1 text-left">
                <p className={`font-bold text-sm ${selectedMethod === "upi" ? "text-blue-900" : "text-slate-900"}`}>
                  Google Pay / PhonePe
                </p>
            ...
            >
              ...
              <div className="flex-1 text-left">
                <p className={`font-bold text-sm ${selectedMethod === "card" ? "text-blue-900" : "text-slate-900"}`}>
                  Credit / Debit Card
                </p>
