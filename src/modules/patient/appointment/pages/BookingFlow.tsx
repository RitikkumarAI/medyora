    ...
    setTimeout(() => {
      ...
      const newApt = createAppointment({
        ...
        patientDetails: {
          ...
          medicalHistory:
            bookedFor === "self" ? selfData.medicalHistory : otherPatient.medicalHistory,
          problemDescription:
            bookedFor === "self" ? selfData.problemDescription : otherPatient.problemDescription,
      ...
      {step !== "success" && step !== "failed" && (
        <header className="sticky top-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md px-4 pt-6 pb-3 shadow-xs border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5">
            <span
              className={`h-2 w-6 rounded-full transition-colors ${step === "patient" ? "bg-blue-600" : "bg-slate-200 dark:bg-slate-700"}`}
            />
            <span
              className={`h-2 w-6 rounded-full transition-colors ${step === "type" || step === "datetime" ? "bg-blue-600" : "bg-slate-200 dark:bg-slate-700"}`}
            />
            <span
              className={`h-2 w-6 rounded-full transition-colors ${step === "payment" ? "bg-blue-600" : "bg-slate-200 dark:bg-slate-700"}`}
            />
          </div>
        </header>
      )}
          ...
          <div className="p-4 sm:p-6 space-y-6 animate-in slide-in-from-right-4">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-1">
                Select yourself or fill in details for a family member or friend
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <div
                    className={`h-11 w-11 rounded-2xl flex items-center justify-center ${bookedFor === "self" ? "bg-blue-600 text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-500"}`}
                  >
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <div
                    className={`h-11 w-11 rounded-2xl flex items-center justify-center ${bookedFor === "other" ? "bg-blue-600 text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-500"}`}
                  >
            ...
            {bookedFor === "self" && (
              <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-100 dark:border-slate-800 shadow-xs space-y-3 animate-in fade-in">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                        {selfData.gender}, {selfData.age} yrs • {selfData.phone}
                      </p>
                    </div>
                  </div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  Your registered medical ID will be automatically linked to this booking.
                </p>
              </div>
            )}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="col-span-2 space-y-1">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setOtherPatient((prev) => ({ ...prev, name: e.target.value }))
                      }
                  ...
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setOtherPatient((prev) => ({ ...prev, relation: e.target.value }))
                      }
                  ...
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setOtherPatient((prev) => ({ ...prev, age: e.target.value }))
                      }
                      className="rounded-xl bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 h-11 text-sm font-medium text-slate-900 dark:text-white"
                    />
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setOtherPatient((prev) => ({ ...prev, gender: e.target.value }))
                      }
                      className="w-full rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 h-11 px-3 text-sm font-medium outline-none focus:ring-2 focus:ring-blue-600 text-slate-900 dark:text-white"
                    >
                  ...
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setOtherPatient((prev) => ({ ...prev, city: e.target.value }))
                      }
                      className="rounded-xl bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 h-11 text-sm font-medium text-slate-900 dark:text-white"
                    />
                  </div>
                  ...
                  <div className="col-span-2 space-y-1">
                    <label className="text-xs font-bold text-slate-700 dark:text-slate-300">
                      Past Medical History / Existing Illnesses
                    </label>
                    <Input
                      placeholder="e.g. Diabetes, High Blood Pressure, Heart Stent, None"
                      value={otherPatient.medicalHistory}
                      onChange={(e) =>
                        setOtherPatient((prev) => ({ ...prev, medicalHistory: e.target.value }))
                      }
                      className="rounded-xl bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 h-11 text-sm font-medium text-slate-900 dark:text-white"
                    />
                  </div>
                  ...
                  <div className="col-span-2 space-y-1">
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        setOtherPatient((prev) => ({ ...prev, problemDescription: e.target.value }))
                      }
            ...
            <Button
              ...
              disabled={
                bookedFor === "other" && (!otherPatient.name || !otherPatient.problemDescription)
              }
        ...
        {step === "type" && (
          <div className="p-4 sm:p-6 space-y-4 animate-in slide-in-from-right-4">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-1">
                Choose how you'd like the consultation to take place
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`h-12 w-12 rounded-2xl flex items-center justify-center shrink-0 ${consultType === "clinic" ? "bg-blue-600 text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-500"}`}
                  >
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`h-12 w-12 rounded-2xl flex items-center justify-center shrink-0 ${consultType === "video" ? "bg-blue-600 text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-500"}`}
                  >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                      High quality encrypted video call with digital prescription
                    </p>
              ...
              {doctor.homeVisit && (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div
                      className={`h-12 w-12 rounded-2xl flex items-center justify-center shrink-0 ${consultType === "home" ? "bg-blue-600 text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-500"}`}
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                        Doctor visits patient at their home/locality in {doctor.city}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <Button
              ...
              className="w-full h-14 rounded-2xl bg-blue-600 text-white font-bold text-sm shadow-lg shadow-blue-600/25 mt-6"
            >
            ...
            <div className="p-4 sm:p-6 pb-2">
              ...
              <div className="flex gap-2.5 overflow-x-auto scrollbar-hide pb-2">
                {dates.map((d, i) => (
                  ...
                  >
                    <span
                      className={`text-[11px] font-bold uppercase mb-0.5 ${selectedDateIndex === i ? "text-blue-100" : "text-slate-400"}`}
                    >
                      {d.day}
                    </span>
                    <span
                      className={`text-2xl font-black ${selectedDateIndex === i ? "text-white" : "text-slate-900 dark:text-white"}`}
                    >
                      {d.date}
                    </span>
                    <span
                      className={`text-[10px] font-bold ${selectedDateIndex === i ? "text-blue-200" : "text-slate-400"}`}
                    >
                      {d.month}
                    </span>
                  </button>
        ...
        {step === "payment" && (
          <div className="p-4 sm:p-6 space-y-5 animate-in slide-in-from-right-4">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-1">
                Prepay online to save ₹100 instantly, or pay in cash at clinic
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div className="flex items-start gap-3.5 pr-20">
                  <div
                    className={`h-11 w-11 rounded-2xl flex items-center justify-center shrink-0 ${paymentMode === "online" ? "bg-blue-600 text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-500"}`}
                  >
              ...
              >
                <div className="flex items-start gap-3.5">
                  <div
                    className={`h-11 w-11 rounded-2xl flex items-center justify-center shrink-0 ${paymentMode === "pay_at_clinic" ? "bg-blue-600 text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-500"}`}
                  >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-0.5">
                      Pay via Cash / Card when you arrive for consultation
                    </p>
                    <p className="text-xs font-bold text-slate-600 dark:text-slate-400 mt-1.5">
                      No advance fee charged right now
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-100 dark:border-slate-800 shadow-xs space-y-3">
              ...
              <div className="space-y-2 text-sm font-medium">
                ...
                <div className="flex justify-between font-black text-slate-900 dark:text-white pt-3 border-t border-slate-100 dark:border-slate-800 text-base">
                  <span>
                    {paymentMode === "online" ? "Total Amount to Pay" : "Total Due at Clinic"}
                  </span>
              ...
              <div className="pt-3 border-t border-slate-100 dark:border-slate-800 text-xs text-slate-500 dark:text-slate-400 flex items-center justify-between">
                <span>
                  ...
                  <strong className="text-slate-800 dark:text-slate-200">
                    {activePatientName} ({activePatientRelation})
                  </strong>
                </span>
                <span>
        ...
        {step === "success" && (
          <div className="p-4 sm:p-6 space-y-6 animate-in fade-in zoom-in-95 duration-400">
            ...
            <div className="text-center pt-2">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-1">
                Ref: <strong>{bookingRef}</strong> • Confirmed with clinic
              </p>
            </div>
            ...
            <div className="bg-emerald-50 dark:bg-emerald-950/40 rounded-3xl p-5 border border-emerald-200 dark:border-emerald-800 shadow-xs space-y-3">
              ...
              <div className="bg-white dark:bg-slate-900 p-3.5 rounded-2xl border border-emerald-100 dark:border-emerald-900/60 text-xs text-slate-700 dark:text-slate-300 space-y-1.5 leading-relaxed">
                ...
                <p>
                  Hello <strong>{activePatientName}</strong>, your appointment is confirmed with{" "}
                  <strong>{doctor.fullName}</strong> at <strong>{doctor.clinic.name}</strong> for{" "}
                  <strong>
                    {selectedDateObj.day}, {selectedTime}
                  </strong>
                  .
          ...
          <div className="bg-[#ECE5DD] dark:bg-slate-900 w-full max-w-sm rounded-[32px] overflow-hidden shadow-2xl animate-in zoom-in-95 border border-slate-300 dark:border-slate-800">
            ...
            <div className="p-4 space-y-3 max-h-[360px] overflow-y-auto">
              <div className="bg-white dark:bg-slate-850 p-3.5 rounded-2xl rounded-tl-sm shadow-xs text-xs text-slate-800 dark:text-slate-200 space-y-2 border border-slate-200 dark:border-slate-750">
                ...
                <p>
                  Dear <strong>{activePatientName}</strong>,
                </p>
                <p>Your appointment has been successfully scheduled:</p>
                <div className="bg-slate-50 dark:bg-slate-800 p-2.5 rounded-xl space-y-1 font-medium text-[11px]">
                  <p>
                    👨‍⚕️ <strong>Doctor:</strong> {doctor.fullName} ({doctor.speciality})
                  </p>
                  <p>
                    📍 <strong>Clinic:</strong> {doctor.clinic.name}, {doctor.clinic.city}
                  </p>
                  <p>
                    🗓️ <strong>Date & Time:</strong> {selectedDateObj.day}, {selectedTime}
                  </p>
                  <p>
                    🎟️ <strong>Live Token:</strong> {generatedToken}
                  </p>
                  <p>
                    💳 <strong>Payment:</strong>{" "}
                    {paymentMode === "online"
                      ? `Paid Online (₹${finalAmount})`
                      : `Pay at Clinic (₹${finalAmount})`}
                  </p>
                </div>
              ...
              <div className="bg-white dark:bg-slate-850 p-3 rounded-2xl rounded-tl-sm shadow-xs text-xs text-slate-800 dark:text-slate-200 space-y-1 border border-slate-200 dark:border-slate-750">
                ...
                <p className="text-[11px]">
                  Next reminder will trigger 1 hour before appointment with live queue token call
                  status.
                </p>
            ...
            <div className="p-3 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800">
              <Button
                onClick={() => setShowWhatsAppModal(false)}
                className="w-full rounded-xl bg-[#075E54] dark:bg-emerald-800 hover:bg-emerald-700 text-white font-bold text-xs h-10"
              >
                Close Preview
              </Button>
            </div>
