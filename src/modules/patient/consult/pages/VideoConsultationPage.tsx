...
export function VideoConsultationPage() {
  ...
  const [selectedSpeciality, setSelectedSpeciality] = useState<
    (typeof INSTANT_SPECIALITIES)[0] | null
  >(null);
          ...
          <div className="grid grid-cols-12 gap-8 items-center">
            <div className="col-span-12 lg:col-span-7 space-y-5">
              ...
              <p className="text-xs sm:text-sm text-slate-300 max-w-xl leading-relaxed">
                Connect with verified Specialists 24/7 over encrypted HD video calls. Receive
                official digital prescription with dosage instructions immediately after
                consultation.
              </p>
          ...
          {upcomingConsultations.length === 0 ? (
            <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 text-center space-y-2">
              ...
              <p className="text-xs font-bold text-slate-700 dark:text-slate-300">
                No active video appointments scheduled.
              </p>
              <p className="text-[11px] text-slate-400">
                Choose a speciality above to start an instant 2-minute call.
              </p>
            </div>
          ) : (
            ...
            {pastConsultations.map((consult) => (
              ...
              >
                ...
                <div className="flex gap-2 shrink-0">
                  ...
                  >
                    <Link to="/booking/$doctorId" params={{ doctorId: consult.doctorId || "dr-1" }}>
                      Rebook
                    </Link>
                  </Button>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-400">
                      {activeCall.speciality} • Secure End-to-End Encrypted Call
                    </p>
                  </div>
                </div>
                <button
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-transparent to-transparent flex flex-col justify-end p-6">
                  <div className="bg-slate-900/80 backdrop-blur-md p-3.5 rounded-2xl border border-slate-700/60 max-w-md space-y-1">
                    ...
                    <p className="text-xs text-slate-200">
                      "Hello! I am reviewing your health history. Please tell me about your
                      symptoms."
                    </p>
                  </div>
                </div>
