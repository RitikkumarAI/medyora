  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 transition-colors">
      ...
      <div className="hidden md:flex min-h-screen">
        ...
        <aside
          className="w-64 bg-slate-900 border-r border-slate-800 p-5 flex flex-col justify-between shrink-0 sticky top-0 h-screen overflow-y-auto"
          role="navigation"
          ...
          <div className="pt-4 border-t border-slate-800 space-y-2">
            <div className="grid grid-cols-2 gap-1.5">
              <Button
                ...
                variant="outline"
                size="sm"
                className="h-8 text-[10px] font-bold rounded-xl bg-slate-800 border-slate-700 text-slate-200 hover:bg-slate-700"
              >
        ...
        <main
          id="main-content"
          tabIndex={-1}
          className="flex-1 min-w-0 overflow-x-hidden p-6 lg:p-8 bg-slate-950 focus:outline-none"
        >
          <Outlet />
        </main>
      </div>
      ...
      <div className="flex md:hidden flex-col min-h-screen">
        ...
        <nav
          className="fixed bottom-0 left-0 right-0 bg-slate-900 border-t border-slate-800 p-2 pb-safe z-50 shadow-[0_-10px_20px_-10px_rgba(0,0,0,0.5)]"
          role="navigation"
        ...
        >
          <div className="flex items-center justify-around">
            <Link
              to="/admin"
              className={`flex flex-col items-center gap-1.5 px-4 py-2 rounded-2xl transition-all ${currentPath === "/admin" ? "text-indigo-400 bg-indigo-950/80 scale-105" : "text-slate-400 hover:text-slate-200"}`}
            >
              <LayoutDashboard
                className={`h-6 w-6 ${currentPath === "/admin" ? "fill-indigo-900" : ""}`}
              />
            ...
            <Link
              to="/admin/users"
              className={`flex flex-col items-center gap-1.5 px-4 py-2 rounded-2xl transition-all ${currentPath.includes("/admin/users") ? "text-indigo-400 bg-indigo-950/80 scale-105" : "text-slate-400 hover:text-slate-200"}`}
            >
              <Users
                className={`h-6 w-6 ${currentPath.includes("/admin/users") ? "fill-indigo-900" : ""}`}
              />
            ...
            <Link
              to="/admin/cms"
              className={`flex flex-col items-center gap-1.5 px-4 py-2 rounded-2xl transition-all ${currentPath.includes("/admin/cms") ? "text-indigo-400 bg-indigo-950/80 scale-105" : "text-slate-400 hover:text-slate-200"}`}
            >
              <FileText
                className={`h-6 w-6 ${currentPath.includes("/admin/cms") ? "fill-indigo-900" : ""}`}
              />
            ...
            <Link
              to="/admin/settings"
              className={`flex flex-col items-center gap-1.5 px-4 py-2 rounded-2xl transition-all ${currentPath.includes("/admin/settings") ? "text-indigo-400 bg-indigo-950/80 scale-105" : "text-slate-400 hover:text-slate-200"}`}
            >
              <Settings
                className={`h-6 w-6 ${currentPath.includes("/admin/settings") ? "fill-indigo-900" : ""}`}
              />
