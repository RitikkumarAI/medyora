...
USERS.push(
  { id: "u1", name: "Ritik Kumar", role: "Patient", status: "Active", image: "https://ui-avatars.com/api/?name=Ritik+Kumar&background=eff6ff&color=3b82f6", speciality: "" },
  { id: "u2", name: "Rahul Sharma", role: "Patient", status: "Inactive", image: "https://ui-avatars.com/api/?name=Rahul+Sharma&background=fffbeb&color=b45309", speciality: "" }
);
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F8FAFC]">
      ...
      <main className="flex-1 overflow-y-auto px-4 py-6 space-y-3 pb-24">
        {filtered.map(user => (
          <div key={user.id} className="bg-white p-4 rounded-3xl border border-slate-100 shadow-sm flex items-center justify-between">
            <div className="flex items-center gap-4">
              <img src={user.image} alt={user.name} className="h-12 w-12 rounded-full object-cover border border-slate-100" />
              <div>
