...
const CMS_CARDS = [
  {
    ...
    icon: ImageIcon,
    count: 4,
    desc: "Manage home screen promo banners",
  ...
  },
  {
    ...
    icon: MessageSquare,
    count: 12,
    desc: "Edit Help Center questions",
  ...
  },
  {
    ...
    icon: Newspaper,
    count: 28,
    desc: "Manage health tips and blog posts",
...
export function AdminCMS() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F8FAFC]">
      ...
      <main className="flex-1 overflow-y-auto px-4 py-6 space-y-6 pb-24">
        ...
        <div className="grid gap-4">
          {CMS_CARDS.map((card) => (
            <div
              key={card.id}
              className="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm group hover:border-indigo-200 transition-colors cursor-pointer"
            >
      ...
      <Button
        size="icon"
        className="fixed bottom-[100px] right-6 h-14 w-14 rounded-full bg-indigo-600 text-white shadow-lg shadow-indigo-600/30 z-40"
      >
