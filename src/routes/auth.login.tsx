...
export const Route = createFileRoute("/auth/login")({
  validateSearch: (search: Record<string, unknown>): LoginSearch => ({
    role: (search["role"] as "patient" | "doctor") || undefined,
  }),
  component: LoginPage,
});
...
export function LoginPage() {
  ...
  const handleDoctorSubmit = (e: React.FormEvent) => {
    ...
    const doctorName = effectiveRegNo
      ? `Dr. Specialist (${effectiveRegNo})`
      : "Dr. Verified Medical Officer";
      ...
      <div className="flex-1 flex flex-col max-w-md mx-auto w-full">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-[10px] text-emerald-700 dark:text-emerald-300 font-medium">
                Test Number: <span className="font-bold">9876543210</span> • OTP/PIN:{" "}
        ...
        {activeTab === "patient" && (
          <form
            ...
            className="space-y-4 bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-sm"
          >
        ...
        {activeTab === "doctor" && (
          <form
            ...
            className="space-y-4 bg-white dark:bg-slate-900 p-6 rounded-3xl border-2 border-blue-600/30 dark:border-blue-500/30 shadow-md"
          >
