...
function TermsOfService() {
  return (
    <article className="prose prose-slate dark:prose-invert max-w-none">
      ...
      <p>
        By accessing our platform, you agree to be bound by these Terms of Service and to use
        the platform in accordance with these Terms, our Privacy Policy, and any additional
        terms and conditions that may apply to specific sections of the platform.
      </p>
      ...
      <p>
        In no event shall Medyora, nor its directors, employees, partners, agents, suppliers,
